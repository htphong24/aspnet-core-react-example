    ...
    this.props.form.validateFields(async (err, values) => {
      if (!err) {
        try {
          ...
          const response = await updateContact(submitRequest);
          // console.log(
          //   "ContactUpdateForm > handleSubmit > response:\n",
          //   response
          // );
          this.props.onUpdated(response.data.Contact);
        } catch (error) {
          // console.log(
          //   "ContactUpdateForm > handleSubmit > error (catch):\n",
          //   error
          // );
